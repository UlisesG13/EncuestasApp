...
android {
    namespace = "com.ulisesg.encuestasapp"
    compileSdk = 36

    defaultConfig {
        applicationId = "com.ulisesg.encuestasapp"
        minSdk = 31
        targetSdk = 36
        versionCode = 1
        versionName = "1.0"
...
secrets {
    // Corregido: propertiesFileName
    propertiesFileName = "local.properties"
    // Comentado porque el archivo local.defaults.properties no existe en tu proyecto
